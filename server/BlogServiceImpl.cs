...
namespace server
{
    public class BlogServiceImpl : BlogServiceBase
    {
        ...
        private static IMongoDatabase mongoDatabase = mongoClient.GetDatabase("grpc-blog");
        private static IMongoCollection<BsonDocument> mongoCollection = mongoDatabase.GetCollection<BsonDocument>("blog");

        public override Task<CreateBlogResponse> CreatBlog(CreateBlogRequest request, ServerCallContext context)
        {
